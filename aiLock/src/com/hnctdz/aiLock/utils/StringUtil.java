...
public class StringUtil {
	...
	/**
	 * 将字符串转成Integer数组(例："21,12" return:[21,12])
	 * @param strs 需要转的字符串
	 * @return Integer[]
	 */
	public static Integer[] stringToIntArray(String strs){
		String[] str = strs.split(",");
		Integer[] recordId = new Integer[str.length];
		for(int i=0; i < str.length; i++){
			recordId[i] = Integer.parseInt(str[i]);
		}
		return recordId;
    }
